 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 100, 93 }   //Orig { 80, 80, 4000, 500 } 93*2 = DRV8825 1/32 Stepps
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 2000, 2000, 500, 50 } // ...or, set your own edit limits
#endif
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 2000, 2000, 500, 20000 } // ...or, set your own edit limits
#endif
...
#define MESH_BED_LEVELING //patofoto
...
#define ENABLE_LEVELING_AFTER_G28 //patofoto
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 5          // Set Mesh bounds as an inset region of the bed //patofoto
  #define GRID_MAX_POINTS_X 6    // Don't use more than 7 points per axis, implementation limited. //patofoto
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define Z_SAFE_HOMING //  PANDAPI
  ...
  #define Z_SAFE_HOMING_X_POINT 1//X_CENTER  // X point for Z homing /patofoto
  #define Z_SAFE_HOMING_Y_POINT 1//Y_CENTER  // Y point for Z homing
#endif

// Homing speeds (mm/min)
#define HOMING_FEEDRATE_MM_M { (20*60), (20*60), (4*60) } //patofoto
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 1), (Y_MAX_POS - 1), 0 }  //patofoto
...
//PANDAPI
//only for TMC2209
#define X_CURRENT_PI		600 	   // (mA) RMS current. Multiply by 1.414 for peak current.
